...
- Read [references/env-vars.md](references/env-vars.md) when you need a debug switch (`DOGESH_LOG`, PTY/terminal/completion toggles) or an `AI_CHAT_*` setting instead of editing code.
