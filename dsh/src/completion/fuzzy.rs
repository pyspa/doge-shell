...
impl FuzzyCompletion {
    ...
    pub fn filter_candidates(&self, candidates: Vec<Candidate>, query: &str) -> Vec<ScoredCandidate> {
        if query.is_empty() {
            return candidates
                .into_iter()
    ...
    pub fn filter_with_threshold(&self, candidates: Vec<Candidate>, query: &str, min_score: i64) -> Vec<ScoredCandidate> {
