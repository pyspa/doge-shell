...
Profiles:
  ...
  dogesh-user       dsh-cron, dsh-skill-authoring, dsh-chat   (product-user skills: cron jobs, skill authoring, and ! chat use; not repo-dev skills)
...
profile_skills() {
    case "$1" in
        ...
        codex-common|dogesh-common|claude-common)
            ...
            ;;
        dogesh-user)
            printf '%s\n' dsh-cron dsh-skill-authoring dsh-chat
            ;;
        *)
